<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="neworderList" @selection-change="handleSelectionChange" border>
      ...
      <el-table-column label="实付金额" align="center" prop="price" fixed="left" width="100"/>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      this.loading = true
      listChannelNeworder(this.queryParams).then(response => {
    ...
    orderDetaileBtn(row) {
      ...
      listChannelNeworderDetail(this.orderDetailsQueryParams)
        .then(res => {
          if (res.code == 200) {
