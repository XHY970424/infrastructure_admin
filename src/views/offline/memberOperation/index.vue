  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      <el-form-item label="操作类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择操作类型" size="small">
          <el-option label="开通会员" :value="0"/>
          <el-option label="升级会员" :value="4"/>
        </el-select>
      </el-form-item>
      <el-form-item>
...
<!--          size="mini"-->
<!--          @click="handleExport"-->
<!--          v-hasPermi="['offline:operation:export']"-->
<!--        >导出-->
<!--        </el-button>-->
<!--      </el-col>-->
<!--    </el-row>-->
    ...
    <el-table v-loading="loading" :data="operationList" @selection-change="handleSelectionChange" border>
      ...
      <el-table-column label="收费档次" align="center" prop="memberPrice">
        <template slot-scope="scope">
          <span v-show="scope.row.memberPrice">{{scope.row.memberPrice}}元/年</span>
          <span v-show="!scope.row.memberPrice"></span>
        </template>
      </el-table-column>
      <el-table-column label="开通人数" align="center" prop="number"/>
      <el-table-column label="开通期限" align="center" prop="memberDeadline"/>
